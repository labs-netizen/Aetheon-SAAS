...
- **External Service**: Python FastAPI microservice (`POST /v1/renewables/reconcile`).
...
- **Reports**: `RENEWABLES_RECONCILIATION` (measured vs modelled generation, performance ratio, and avoided emissions).
