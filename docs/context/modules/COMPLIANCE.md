...
- **Tests**: `tests/integration/adversarial_api.test.ts` (Test 13, 14), `tests/integration/authority_and_auditability.test.ts`, `tests/e2e/demo_smoke.spec.ts` (Test 10), `tests/e2e/real_auth_workflows.spec.ts` (Test 7).
