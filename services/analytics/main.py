...
@app.post("/v1/bess/sizing", response_model=BESSSizingResponse)
def size_bess(req: BESSSizingRequest, _=Depends(verify_service_token)):
    return solve_bess_sizing(req)
