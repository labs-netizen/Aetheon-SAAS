...
2. **Read [`docs/PRODUCT_SPECIFICATION.md`](file:///d:/Consultancy%20Project/Aetheon-SAAS/docs/PRODUCT_SPECIFICATION.md)** only when functional/domain product requirements are needed.
3. **Read [`docs/context/CURRENT_STATE.md`](file:///d:/Consultancy%20Project/Aetheon-SAAS/docs/context/CURRENT_STATE.md)** to inspect verified commit, test, build, migration, and operational status.
4. **Read [`docs/context/CODEBASE_MAP.md`](file:///d:/Consultancy%20Project/Aetheon-SAAS/docs/context/CODEBASE_MAP.md)** to locate architectural layers and directory structure.
5. **Read only the relevant module file(s)** under [`docs/context/modules/`](file:///d:/Consultancy%20Project/Aetheon-SAAS/docs/context/modules/) (`GRID.md`, `DSM.md`, `BESS.md`, `COMPLIANCE.md`, `RENEWABLES.md`, `INGESTION.md`, `BILLING.md`, `REPORTS.md`, `ALERTS.md`, `AUTH.md`, `ADMIN.md`).
...
1. **[`docs/PRODUCT_SPECIFICATION.md`](file:///d:/Consultancy%20Project/Aetheon-SAAS/docs/PRODUCT_SPECIFICATION.md)** — Definitive domain & product requirements.
