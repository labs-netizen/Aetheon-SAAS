...
-- Operational DSM publication is restricted to customer roles authorised to mutate module state.
CREATE OR REPLACE FUNCTION public.commit_dsm_evaluation_atomic(p_site_id uuid, p_org_id uuid, p_actor_id uuid,
...
BEGIN
  v_role := public.assert_actor_authority(p_actor_id,p_org_id,
    ARRAY['ORGANISATION_ADMIN','ENERGY_MANAGER'],p_site_id);
