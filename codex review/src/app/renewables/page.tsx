...
export default function RenewablesPage() {
  ...
  // Solar asset demo parameters
  const solarAsset = {
    name: 'Factory Rooftop Solar PV Phase 1',
    installedCapacityKw: 1200.0,
    technology: 'Crystalline Silicon Rooftop',
    measuredGenerationKwh: 4420.0, // MEASURED
    modelledGenerationKwh: 4680.0, // MODELLED
    estimatedGenerationKwh: 4500.0,// ESTIMATED
    selfConsumptionKwh: 3910.0,
    gridExportKwh: 510.0,
    avoidedEmissionsTco2e: 3.16,
    emissionFactorSource: 'CEA_CO2_BASELINE_DB_v19_DEMO (0.716 tCO2e/MWh)',
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <ProvenanceFooter
        ...
        ruleVersion="CEA_CO2_BASELINE_DB_v19_DEMO"
      />
    </div>
  );
}
